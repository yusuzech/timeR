...
your analysis. You can use `timeR` to timing training time for machine learning models, record speed for requests hen runing web-scrapinging codes or other situations that you need to keep records of time.
